  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div>
          <div style={{ fontSize: 20, fontWeight: 700, color: '#1B3A6B', paddingLeft: 12, borderLeft: '3px solid #F0B429' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
          {briefingSentences.map((sentence, i) => (
            <div key={i} style={{
              ...
              <div style={{
                fontSize: 18, color: '#1B3A6B', lineHeight: 1.7, padding: '8px 0',
              }}>
                {sentence}
              </div>
      ...
      {/* One specific action */}
      <div style={{
        marginTop: 20, padding: '16px', background: '#EEF2F9', borderRadius: 8,
      }}>
        <div style={{ fontSize: 14, fontWeight: 700, color: '#1B3A6B', marginBottom: 4 }}>
          What should I do right now?
        </div>
        <div style={{ fontSize: 16, color: '#1B3A6B', lineHeight: 1.6, fontWeight: 500 }}>
          {action}
        </div>
      </div>
      ...
      <div style={{ marginTop: 16, display: 'flex', gap: 12, flexWrap: 'wrap' }}>
        {onAskPulse && (
          <button onClick={onAskPulse} style={{
            ...
            fontSize: 14, color: '#1B3A6B', fontWeight: 600, textDecoration: 'underline',
