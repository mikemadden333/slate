...
const buildNetworkSnapshot = () => ({
  ...
  network:"Veritas Charter Schools",campusCount:10,studentCount:6823,
  watch:{networksAtRisk:2,criticalCampuses:[],elevatedCampuses:["Garfield Park","Englewood"],clearCampuses:8,activeRetaliationWindows:1,retaliationCampus:"Garfield Park",retaliationPhase:"WATCH",retaliationHoursRemaining:52,lastIncident:"Weapons arrest 0.4mi from Garfield Park at 11:42pm",overallStatus:"ELEVATED"},
  ledger:{budgetVariance:-3.8,budgetVarianceDirection:"under",cashDaysOnHand:215,covenantStatus:"COMPLIANT",dscrProjected:3.47,personnelOverBudget:false,topVarianceItem:"Substitute costs tracking 12% above trend",ytdExpenses:75500000,ytdBudget:78500000,quarterlyStatus:"On Track"},
  roster:{enrollmentVsProjection:-18,enrollmentProjection:6841,currentEnrollment:6823,revenueAtRisk:252000,atRiskCampuses:["North Lawndale","Roseland"],yieldTracking:"8% below last year in 9th grade",attritionFlags:3,octCountDaysOut:22},
  ...
  grounds:{openWorkOrders:9,urgentWorkOrders:2,urgentItems:["HVAC failure - Austin 3rd floor","Water main leak - Loop campus"],capitalProjectsActive:3,capitalProjectsOnBudget:2,vendorContractsExpiring:1},
  civic:{billsInCommittee:2,pendingBills:[{name:"HB 4821",summary:"Charter authorization renewal process changes",risk:"WATCH"},{name:"SB 2907",summary:"Per-pupil funding equity adjustment",risk:"POSITIVE"}],upcomingHearings:1,hearingDate:"March 18",hearingTopic:"Charter Funding Equity Subcommittee",staleStakeholderRelationships:3,mediaMonitoring:"No active coverage. One pending Chalkbeat inquiry."},
