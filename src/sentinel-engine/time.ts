...
import { isSchoolDay, getCalendarContext as _getCalendarContext } from '../sentinel-data/calendar';

export { isSchoolDay, isHoliday, getCalendarContext } from '../sentinel-data/calendar';
