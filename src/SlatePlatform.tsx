      ...
      <div style={{ display: "flex", minHeight: "100vh", background: COLORS.bg, fontFamily: "'Inter', system-ui, sans-serif" }}>
        ...
        <div style={{ marginLeft: sidebarWidth, flex: 1, transition: "margin-left 0.3s ease" }}>
          ...
          <div style={{ padding: "28px" }}>
            {activeModule === "dashboard" ? <Dashboard onModuleClick={setActiveModule} /> : activeModule === "sentinel" ? <SentinelApp /> : activeModule === "ledger" ? <LedgerApp /> : <ModulePlaceholder module={activeModuleData} />}
          </div>
        </div>
      </div>
    </>
