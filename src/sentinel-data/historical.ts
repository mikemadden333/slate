...
Fy26
TS 
<div><br class="Apple-interchange-newline">export const HISTORICAL = [<br>  { year: 'FY20', enrollment: 12254, cpsRevenue: 155.3, totalRevenue: 186.5, totalExpenses: 177.0, ebitda: 9.5, netSurplus: 5.8, dscr: 3.35, personnel: 124.2 },<br>  { year: 'FY21', enrollment: 12730, cpsRevenue: 163.8, totalRevenue: 194.7, totalExpenses: 187.2, ebitda: 7.5, netSurplus: 3.1, dscr: 2.30, personnel: 139.3 },<br>  { year: 'FY22', enrollment: 12361, cpsRevenue: 172.9, totalRevenue: 229.1, totalExpenses: 223.9, ebitda: 5.2, netSurplus: -4.9, dscr: 2.41, personnel: 154.0 },<br>  { year: 'FY23', enrollment: 12183, cpsRevenue: 179.3, totalRevenue: 229.2, totalExpenses: 222.1, ebitda: 7.1, netSurplus: 15.7, dscr: 2.70, personnel: 154.8 },<br>  { year: 'FY24', enrollment: 12120, cpsRevenue: 191.0, totalRevenue: 238.9, totalExpenses: 228.1, ebitda: 10.8, netSurplus: 17.4, dscr: 4.60, personnel: 154.8 },<br>  { year: 'FY25', enrollment: 12163, cpsRevenue: 188.8, totalRevenue: 237.0, totalExpenses: 233.9, ebitda: 3.1, netSurplus: -3.0, dscr: 2.82, personnel: 162.5 },<br>];</div>

Show more
9:18 AM

Validated historical financial data scaling
Validated historical financial data scaling
The narrative arc is preserved exactly. FY22 takes a loss, FY23 and FY24 recover strongly - FY24 is the standout year with DSCR hitting 4.60. FY25 tightens back up with a slim defi
...
export const HISTORICAL = [
  { year: 'FY20', enrollment: 6882, cpsRevenue: 87.1,  totalRevenue: 104.6, totalExpenses: 99.3,  ebitda: 5.3,  netSurplus: 3.3,   dscr: 3.35, personnel: 69.7 },
  ...
  { year: 'FY22', enrollment: 6934, cpsRevenue: 97.0,  totalRevenue: 128.5, totalExpenses: 125.6, ebitda: 2.9,  netSurplus: -2.7,  dscr: 2.41, personnel: 86.4 },
  { year: 'FY23', enrollment: 6835, cpsRevenue: 100.6, totalRevenue: 128.6, totalExpenses: 124.6, ebitda: 4.0,  netSurplus: 8.8,   dscr: 2.70, personnel: 86.9 },
  ...
  { year: 'FY25', enrollment: 6823, cpsRevenue: 105.9, totalRevenue: 133.0, totalExpenses: 131.2, ebitda: 1.7,  netSurplus: -1.7,  dscr: 2.82, personnel: 91.1 },
];
